...
# bargrapich
"""
plt.bar([0.25,1.25,2.35,3.25,4.25],[50,40,70,80,20],label="BMW" , width=.5)
...
yaslar=[22,55,62,45,21,22,34,42,42,4,2,102,95,85,55,110,120,70,65,55,111,115,80,75,65,44,43,42,48]
